...
namespace Acamti.Azure.Cosmos
{
    public interface ICosmosProxy
    {
        ...
        IAsyncEnumerable<TDocument> GetDocumentsIteratorAsync<TDocument>(Func<IQueryable<TDocument>, IQueryable<TDocument>> conditionBuilder = null,
            QueryRequestOptions requestOptions = null)
            where TDocument : class;

        Task<IEnumerable<TDocument>> GetDocumentsAsync<TDocument>(Func<IQueryable<TDocument>, IQueryable<TDocument>> conditionBuilder = null,
            QueryRequestOptions requestOptions = null)
            where TDocument : class;
    }
}
